...
def main():
    ...
    filenames_order = list()
    import json
    from pathlib import Path
    for data_info in dataset.data_infos:
        name = Path(data_info["img_info"]["filename"]).name
        name = Path("Test/UNKNOWN") / name
        name = str(name)
        filenames_order.append(name)
    with open("filenames_order.json", "w") as filenames_order_file:
        json.dump(filenames_order, filenames_order_file)
